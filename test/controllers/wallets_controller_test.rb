...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { church_id: @wallet.church_id, kind_of: @wallet.kind_of, name: @wallet.name } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { church_id: @wallet.church_id, kind_of: @wallet.kind_of, name: @wallet.name } }
