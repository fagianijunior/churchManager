...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { kind_of: @movement.kind_of, wallet_id: @movement.wallet_id } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { kind_of: @movement.kind_of, wallet_id: @movement.wallet_id } }
