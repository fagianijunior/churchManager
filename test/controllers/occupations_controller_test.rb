...
class OccupationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occupation" do
    assert_difference("Occupation.count") do
      post occupations_url, params: { occupation: { description: @occupation.description, name: @occupation.name } }
    end
  ...
  test "should update occupation" do
    patch occupation_url(@occupation), params: { occupation: { description: @occupation.description, name: @occupation.name } }
