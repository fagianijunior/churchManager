class DashboardController < ApplicationController
  ...
  def index
    ...
    @monthMovements = Movement.not_entre_contas.where(payment_date: @date_range)
    ...
    @monthTithe = Movement.entrada.dízimo.joins(:user).group('users.id').where(payment_date: @date_range)
